...
import springTemplate.example.springTemplate.services.UserServiceImplementation;
...
public class UserController {
    ...
    public ResponseEntity<User> getUser(String username){
        return ResponseEntity.ok().body(userServiceImplementation.getUser(username));
    }

    @PostMapping("/user/addrole")
    public ResponseEntity<?> addRole(@RequestBody RoleToUser form) {
        userServiceImplementation.addRole(form.getUsername(), form.getRole());
